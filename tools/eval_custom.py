...
def main():
    ...
    folder_name_list = os.listdir(config["Eval"]["dataset"]["data_dir"])
    # folder_name_list = ["C007"]
    for folder_name in folder_name_list:
        config["Eval"]["dataset"]["label_file_list"] = os.path.join(
            config["Eval"]["dataset"]["data_dir"], folder_name, "Label.json"
        )
        ...
        # if metric["hmean"] < 0.986:
        logger.info('metric eval ***************')
        logger.info('Folder eval: %s', folder_name)
